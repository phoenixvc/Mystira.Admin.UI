    ...
    <BrowserRouter>
      <Routes>
        ...
        >
          ...
          <Route path="admin/scenarios/validate" element={<ValidateScenariosPage />} />
          <Route path="admin/media" element={<MediaPage />} />
          <Route path="admin/media/import" element={<ImportMediaPage />} />
          <Route path="admin/media/import-zip" element={<ImportMediaZipPage />} />
          ...
          <Route path="admin/bundles/create" element={<CreateBundlePage />} />
          <Route path="admin/bundles/edit/:id" element={<EditBundlePage />} />
